...
AL2O3_EXTERN_C void Image_CompressAMDRGBSingleModeBlock(float const input[ 4 * 4 * 3 ],bool adaptiveColourWeights, bool b3DRefinement, uint8_t refinementSteps, void *out);
...
AL2O3_EXTERN_C void Image_CompressAMDBC1Block(float const input[ 4 * 4 * 4 ], bool adaptiveColourWeights, bool b3DRefinement, uint8_t refinementSteps, float alphaThreshold, void* out);
